...
var getUserById = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = _req.params.id;
                return [4 /*yield*/, userObject.getUserById(id)];
            case 1:
                result = _a.sent();
...
var user_routes = function (app) {
    app.get('/users', index);
    app.get('/users/:id', [dashboard_1.verifyAuthToken, dashboard_1.isRangerAccount], getUserById);
