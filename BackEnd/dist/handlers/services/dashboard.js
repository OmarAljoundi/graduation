...
exports.isRangerAccount = exports.isUserVaild = exports.isRangerExist = exports.isUserExist = exports.verifyAuthToken = exports.authedUser = void 0;
...
var rangerObj = new ranger_1.default();
var verifyAuthToken = function (req, res, next) {
    ...
    try {
        ...
        jsonwebtoken_1.default.verify(String(token), String(TOKEN_SECRET), function (err, decoded) {
            if (decoded) {
                exports.authedUser = decoded.user ? decoded.user : decoded.ranger;
                next();
            }
            else {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [3 /*break*/, 4];
            case 3: return [2 /*return*/, res.sendStatus(404)];
            case 4: return [2 /*return*/];
        }
    });
}); };
exports.isUserVaild = isUserVaild;
var isRangerAccount = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, ranger;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = exports.authedUser.nationality_id;
                return [4 /*yield*/, rangerObj.checkRanger(id)];
            case 1:
                ranger = _a.sent();
                if (ranger) {
                    next();
                    ...
                    return [2 /*return*/, res.send(401).json("Authentication Required! Please Sign up, or sign in if You already have an account.")];
                }
                return [2 /*return*/];
        }
    });
}); };
exports.isRangerAccount = isRangerAccount;
