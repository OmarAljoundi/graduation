...
var service_routes = function (app) {
    app.get('/services', [dashboard_1.verifyAuthToken, dashboard_1.isRangerAccount], index);
    app.get('/services/:id', dashboard_1.verifyAuthToken, getServiceById);
    app.put('/services/:id', [dashboard_1.verifyAuthToken, dashboard_1.isRangerAccount], updateStatus);
