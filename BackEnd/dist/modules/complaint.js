...
var Complaint = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO complaints(image,description,nearest_attraction,public,place_name,location,user_id) values($1,$2,$3,$4,$5,$6,$7)";
                        return [4 /*yield*/, conn.query(sql, [c.image, c.description, c.nearest_attraction, c.public, c.place_name, c.location, dashboard_1.authedUser.id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "update complaints set status=$1,closedby_id = $2 where id = $3";
                        return [4 /*yield*/, conn.query(sql, [status_1, BigInt(dashboard_1.authedUser.id), cid])];
                    case 2:
                        result = _a.sent();
    ...
    // All users Methods
    Complaint.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
