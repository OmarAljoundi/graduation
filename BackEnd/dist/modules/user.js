...
var User = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Users Couldnt be retrieved, ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    User.prototype.register = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, SALT_ROUNDS, BCRYPT_PASSWORD, conn, sql, password_digest, result, err_3;
    ...
    User.prototype.authenticate = function (phoneNumber, password) {
        return __awaiter(this, void 0, void 0, function () {
            var BCRYPT_PASSWORD, conn, sql, userInfo, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("Users Couldnt be registerd, ".concat(err_4));
                    case 5: return [2 /*return*/];
                }
            });
        });
    ...
    User.prototype.vertifiyPhoneNumber = function (phone_number, code, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var vertify_1, status_1, conn_1, sql_1, err_5;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Couldnt Vertified ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
